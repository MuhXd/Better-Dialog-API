...
class DialogObject_DLL DialogApi {
  public:
	...
	static VP_DialogObject *create(std::string const &character = "", std::string const &text = "", cocos2d::CCNode* characterFrame = cocos2d::CCNode::create(), float textScale = 1.0f, bool skippable = false, cocos2d::ccColor3B color = cocos2d::ccWHITE, std::function<void()> callback = nullptr);
	...
	static VP_DialogLayer* create(cocos2d::CCArray *objects = cocos2d::CCArray::create(), int background = 1, std::function<void()> callback = nullptr);

	static VP_DialogLayer *create(cocos2d::CCArray *objects = cocos2d::CCArray::create(), std::string background = "", std::function<void()> callback = nullptr);
